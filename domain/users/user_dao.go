...
import (
	"errors"
	"fmt"
	"github.com/crispgit/bookstore_users-api/datasources/mysql/users_db"
	"github.com/crispgit/bookstore_users-api/utils/mysql_utils"
	"github.com/crispgit/bookstore_utils-go/logger"
	"github.com/crispgit/bookstore_utils-go/rest_errors"
	"strings"
)
//dao perform the logic to save and retrieve to the database
const (
...
func (user *User) Save() rest_errors.RestErr {
	...
	//defer to execute after return statement
	defer stmt.Close()
